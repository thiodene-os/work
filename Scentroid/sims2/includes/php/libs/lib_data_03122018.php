...
function buildNotificationsTable($company)
{
  ...
  $final_notification_table .= '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>' ;
...
function buildSensorsTable($company)
{
  ...
  if (@mysqli_num_rows($result) > 0) 
  {
    ...
    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC))
    {
      ...
      // Very first page or pages containing 15 Sensors
      if ($num_sensors%15 == 0) // Every 15 records / page
      {
    ...
    if ($iter_page > 1)
    {
      ...
      {
        if ($i == 1)
          $pagination_footer .= '<a href="#" rel="page_' . $i . '" class="page_active">' . $i . '</a>' ;
        else
        {
          //if ($i == $iter_page && strlen($sensors_table_body_partial) != 0)
            $pagination_footer .= '<a href="#" rel="page_' . $i .'" class="page_inactive">' . $i . '</a>' ;
        }
      }
