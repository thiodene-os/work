...
function buildUserEdit($user_id=false)
{
  ...
  if (!$user_id)
  {
    ...
    . '<dl>'
    . '<dt>Name:</dt><dd><input id="company_name" class="text_field" name="name" value="" type="text"></dd>'
    ...
    . '<dt>Password:</dt><dd><input id="email" class="text_field" name="email" value="" type="password"></dd>'
    . '<dt>Address:</dt><dd><textarea id="address" row="3" cols="30"></textarea></dd>'
    . '</dl>'
    . '</div>'
    . '</fieldset>' ;
  }
...
function buildUsersTable($company)
{
  ...
  $final_users_list = '' ;
  $users_table_header  = '<table id="users">
  <thead><tr>
  <th>Name</th>
  <th>Email</th>
  <th>Company</th>
...
function parse_meteo_data($met_parameter)
{
    ...
    switch ($met_parameter) {
        ...
        // Internal Humidity
        case "Internal Humidity": $met_parameter = 'Int. Humidity'; $met_icon = 'icon_hum_inv.png'; break;
        case "Internal Humidity ": $met_parameter = 'Int. Humidity'; $met_icon = 'icon_hum_inv.png'; break;
        case "internal humidity": $met_parameter = 'Int. Humidity'; $met_icon = 'icon_hum_inv.png'; break;
        case "internal humidity ": $met_parameter = 'Int. Humidity'; $met_icon = 'icon_hum_inv.png'; break;
        case "inboxhumidity": $met_parameter = 'Int. Humidity'; $met_icon = 'icon_hum_inv.png'; break;
        case "inbohumidity": $met_parameter = 'Int. Humidity'; $met_icon = 'icon_hum_inv.png'; break;
