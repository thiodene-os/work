...
function buildShowNotificationsTable($equipment=false,$search=false,$company=false)
{
  // Connect to db
  $dbc = db_connect_sims() ;
  $dbc_local = db_connect_local() ;
  ...
  $query3 = "SELECT COUNT(*) FROM activity_equipment $equipment_query $search_query $company_query" ;
