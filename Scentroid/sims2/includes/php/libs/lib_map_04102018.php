...
' ;
    ...
    for (i = 0; i < locations.length; i++) {  
      ...
      labelOrigin: new google.maps.Point(11,50),url: \"/images/marker_scent.png\"}});
      ...
      google.maps.event.addListener(marker, 'click', (function(marker, i) {
        ...
        $(\".box\").each(function()
        {
          this_equipment = $(this).attr(\"equipment\") ;
          
          if (this_equipment == locations[i][0])
          {
            $(this).animate({
                width: \"toggle\"
            });
