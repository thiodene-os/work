...
function buildWindPolygon($equipment)
{
  ...
  if ($nsensor == 2)
  {
    ...
    $triangle_coordinates = calcPolygonCoordinates($lat, $lon, $last_speed_value, $last_direction_value) ;
...
function calcPolygonCoordinates($lat, $lon, $wind_speed, $wind_direction)
{
  ...
  //$triangle_tip_x = $triangle_tip_x * cos(deg2rad($wind_direction)) - $triangle_tip_y * sin(deg2rad($wind_direction)) ;
  //$triangle_tip_y = $triangle_tip_x * sin(deg2rad($wind_direction)) + $triangle_tip_y * cos(deg2rad($wind_direction)) ;
  //$triangle_left_x = $triangle_left_x * cos(deg2rad($wind_direction)) - $triangle_left_y * sin(deg2rad($wind_direction)) ;
  //$triangle_left_y = $triangle_left_x * sin(deg2rad($wind_direction)) + $triangle_left_y * cos(deg2rad($wind_direction)) ;
  //$triangle_right_x = $triangle_right_x * cos(deg2rad($wind_direction)) - $triangle_right_y * sin(deg2rad($wind_direction)) ;
  //$triangle_right_y = $triangle_right_x * sin(deg2rad($wind_direction)) + $triangle_right_y * cos(deg2rad($wind_direction)) ;
  
  $pi = 3.14159265359 ;
  $triangle_tip_nx = $triangle_tip_x * cos($wind_direction*$pi/180) - $triangle_tip_y * sin($wind_direction*$pi/180) ;
  $triangle_tip_ny = $triangle_tip_x * sin($wind_direction*$pi/180) + $triangle_tip_y * cos($wind_direction*$pi/180) ;
  $triangle_left_nx = $triangle_left_x * cos($wind_direction*$pi/180) - $triangle_left_y * sin($wind_direction*$pi/180) ;
  $triangle_left_ny = $triangle_left_x * sin($wind_direction*$pi/180) + $triangle_left_y * cos($wind_direction*$pi/180) ;
  $triangle_right_nx = $triangle_right_x * cos($wind_direction*$pi/180) - $triangle_right_y * sin($wind_direction*$pi/180) ;
  $triangle_right_ny = $triangle_right_x * sin($wind_direction*$pi/180) + $triangle_right_y * cos($wind_direction*$pi/180) ;
