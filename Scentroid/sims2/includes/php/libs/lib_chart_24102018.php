...
function getEquipmentLastMetData($equipment)
{
  ...
  $final_last_met = '' ;
  //$final_last_met = '{lat: ' . $lat . ', lng: ' . $lon . '};' ;
  ...
  foreach ($sensor_obj as $value)
  {
    ...
    $final_last_met .= "Name:" . shortenSensorName($value->name) . " Value:" . strtolower($value->value) . " <br />" ;
  }
      ...
      if ($naxis_half > 0)
      {
        ...
        if ($naxis <= $naxis_half - 1)
        {
          ...
          $axisy .= '{
            ...
            tickColor: "#03b346", // -- Dark theme
            gridColor: "#03b346", // -- Dark theme
            lineColor: "#03b346", // -- Dark theme
            titleFontColor: "#FFFFFF", // -- Dark theme
            labelFontColor: "#FFFFFF" // -- Dark theme
            /* tickColor: "deepskyblue", // -- Light theme
            gridColor: "deepskyblue", // -- Light theme
            lineColor: "deepskyblue", // -- Light theme
