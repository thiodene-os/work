...
$query = "SELECT settings.id AS setting_id, user_id, settings_json
          FROM settings LIMIT 1" ; // LIMIT 1 for testing
...
while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC))
{
  ...
  if ($alarm_sensor_obj)
  {
    ...
    foreach ($alarm_sensor_obj as $alarm_sensor)
    {
      ...
      $sensor_name = $alarm_sensor->sensor ;
      ...
      $query4 = "SELECT sensor.id AS sensor_id, sensor.name AS sensor_name
                ...
                . " ORDER BY sensor.id ASC LIMIT 1" ; // LIMIT 1 for testing
      ...
      while ($row4 = mysqli_fetch_array($result4, MYSQLI_ASSOC))
      {
        ...
        if ($sensor_formula == $alarm_sensor->sensor)
        {
          ...
          if (mysqli_num_rows($result2) == 0)
          {
            ...
            $query3 = "INSERT INTO alarmcheckpoint_sensor (user_id, sensor_id, low_point, high_point, enabled, created_dt) VALUES (" 
                      . $user_id . ", " . $sensor_id . ", " . $low_point . ",NOW()); " ;
          ...
          else
          {
            ...
            $query3 = "UPDATE alarmcheckpoint_sensor 
                       SET low_point='" .  . "', high_point='" .  . "', enabled='$enabled'"
