...
while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC))
{
  ...
  // If not create them
  $query2 = "SELECT canvasjs_equipment.id AS canvasjs_id
  ...
  if (mysqli_num_rows($result2) == 0)
  {
    ...
    foreach ($date_range as $dr) 
    {
      ...
      $query4 = "INSERT INTO canvasjs_equipment (equipment_id, daterange_id) VALUES (" . $equipment_id . ", " . $dr . "); " ;
  ...
  else
  {
    ...
    foreach ($date_range as $dr)
    {
      $query5 = "SELECT canvasjs_equipment.id AS canvasjs_id
            FROM canvasjs_equipment
            WHERE equipment_id = " . $equipment_id
            . " AND daterange_id = " . $dr ;
