...
$query = "SELECT lastvalue_equipment_test.id AS lastvalue_id, equipment_id, company_id 
...
if (mysqli_num_rows($result) != 0)
{
  ...
  $query4 = "UPDATE lastvalue_equipment_test 
...
else
{
  ...
  $query3 = "UPDATE lastvalue_equipment_test 
             SET updated_dt=NOW()"
            . " WHERE id = " . $update_value_id ;
...
echo "Update Latest Values Sims2:OK; \n" ;
