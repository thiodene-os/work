...
while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC))
{
  ...
  if (mysqli_num_rows($result2) == 0)
  {
    ...
    {
      // Change the old notification to inactive UPDATE -> 'y'
      $query7 = "SELECT activity_equipment.id AS activity_id
                 FROM activity_equipment
                 WHERE equipment_id = " . $equipment_id
      ...
      if (mysqli_num_rows($result7) != 0)
      {
        ...
        $activity_id = $row7[0] ;
        // Now UPDATE
        $query8 = "UPDATE activity_equipment SET inactive='y' WHERE id = " . $activity_id ;
