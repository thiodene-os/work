...
if (isset($_GET['update'])) 
{
  ...
  if (strlen($sensor_id) == 0)
  {
    ...
    $query = "INSERT INTO sensor (name, packet_id, equipement, type, dataunit, calibrationfactors, alarm_max_value, alarm_value_total, alarm_value_num, extra, createdat, creator) VALUES ('"
              . $name . "', '" . $packet_id . "', '" . $equipment_id . "', '" 
              .  $type . "', '" . $dataunit . "', '[\"\",\"\"]', '0', '0', '0', '"  . $extra . "', '"  . $createdat . "', 10); " ;
