          ...
          prn_dlg = 
              ...
              + '<div style="height:400px; overflow:auto;">'
                  + '<table class="scroll settings_table">'
                    ...
                    + '</thead>'
                    + '<tbody equipment_id="' + equipment_id + '">'
                    + response
                    + '</tbody>'
                  + '</table>'
              + '</div>'
...
// This functionality is used to Edit Company (APACHE)
$( function() 
{
  ...
  $(".edit_company").click(function()
  {
    ...
    company_id = this_parent.attr("company_id");
    ...
    var new_page_url = url_array[0] + '/company/edit_company.php?id=' + company_id ;
  ...
  $(".delete_company").click(function()
  {
    ...
    $.ajax({
        ...
        dataType: "html",   //expect html to be returned   
        data: {company_id: company_id, delete:true},
        success: function(response)
        {
          ...
          if (response.length == 0)
          {
            ...
            this_parent.remove() ;
            alert_script = '<script>alert("One Company has just been deleted!") ;</script>' ;
            
            $("#settings_company_container").html(alert_script); // Overview page for now
          }
          else
          {
            // Diagnose the error from Back-End if Settings could not be saved
            alert_script = '<script>alert("' + response + '") ;</script>' ;
            $("#settings_company_container").html(alert_script);
          }
        }
    });
  ...
  $(".add_company").click(function()
  {
    ...
    // create an array of the current URL considering being located in the settings page
    var url_array = page_url.split ("/settings") ;
    // redirect page for editing Company
    var new_page_url = url_array[0] + '/company/add_company.php' ;
...
// This functionality is used to Edit Sensors (APACHE)
$( function() 
{
  ...
  $(".edit_sensor").click(function()
  {
    ...
    this_parent = $(this).parent().parent() ;
    // get id of the user
    sensor_id = this_parent.attr("sensor_id");
    equipment_id = this_parent.parent().attr("equipment_id");
    // Display the corresponding page that has to be reached on click
    var page_url = window.location.href ;
    ...
    var url_array = page_url.split ("/settings") ;
    // redirect page for editing user
    var new_page_url = url_array[0] + '/sensor/edit_sensor.php?equipment_id=' + equipment_id + '&id=' + sensor_id ;
  ...
  $(".delete_sensor").click(function()
  {
    ...
    $.ajax({
        ...
        dataType: "html",   //expect html to be returned   
        data: {sensor_id: sensor_id, equipment_id: equipment_id, delete:true},
        success: function(response)
        {
          // If the response has content it means the Login failed
          if (response.length == 0)
          {
            ...
            // Remove the row upon success
            this_parent.remove() ;
            alert_script = '<script>alert("One Sensor has just been deleted!") ;</script>' ;
            
            $("#settings_sensor_container").html(alert_script); // Overview page for now
          }
          else
          {
            // Diagnose the error from Back-End if Settings could not be saved
            alert_script = '<script>alert("' + response + '") ;</script>' ;
            $("#settings_sensor_container").html(alert_script);
          }
        }
    });
  ...
  $(".add_sensor").click(function()
  {
    ...
    var new_page_url = url_array[0] + '/sensor/add_sensor.php' ;
...
// This functionality is used to Edit Equipments (APACHE)
$( function() 
{
  ...
  $(".edit_equipment").click(function()
  {
    ...
    var url_array = page_url.split ("/settings") ;
    // redirect page for editing user
    var new_page_url = url_array[0] + '/equipment/edit_equipment.php?id=' + equipment_id ;
...
// This functionality is used to Edit or Delete a user (APACHE)
$( function() 
{
...
$( function() 
{
  ...
  $(".btn_save_settings").click(function()
  {
    ...
    $("#aqi tbody tr").each(function()
    {
      ...
      equipment_id = $(this).parent().attr('equipment_id') ;
      ...
      if(sensor_id)
      {
        ...
        info_aqi += '"equipment_id":"' + equipment_id + '",' ;
