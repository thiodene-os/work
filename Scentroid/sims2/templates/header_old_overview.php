...
function initMap() 
{
  ...
  var map = new google.maps.Map(
      document.getElementById('map'), {zoom: 16, center: equipment, mapTypeId: 'satellite'});
...
@import url(/includes/css/show_table_full.css);
@import url(/includes/css/show_map_full.css);                     
</style>
...
<a class="user_logout" href="http://sims2.scentroid.com/logout"> <i class="fa fa-sign-in fa-2x"></i>Sign Out</a></div>
</div>
