...
<button class="section">Company Information: [USER,MANAGER]</button>
<div class="panel">
  <?php echo $company_info_div ; ?>
</div>

<button class="section">Users: [MANAGER]</button>
<div class="panel">
...
<button class="section">Notifications: [USER,MANAGER]</button>
<div class="panel">
  <?php echo $notification_table ; ?>
</div>

<button class="section">Health Categories for Concentration to AQI: [USER,MANAGER]</button>
<div class="panel">
  <?php echo $aqi_table ; ?>
</div>
