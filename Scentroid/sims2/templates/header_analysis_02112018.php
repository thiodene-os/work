...
<div id="main_content">
<div style="background-color:white;color:black;padding:10px 70px 0px 70px; margin:0;"><a id="logo" href="http://207.246.86.177" title="SIMS 2.0"><img src="/images/logo.jpg" /></a>
...
<a class="user_logout" href="http://207.246.86.177/logout"> <i class="fa fa-sign-in fa-2x"></i>Sign Out</a></div>
</div>
