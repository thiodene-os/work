...
else
{
  // Use one by default
  //$company = 31 ;
  $company = getSessionCompanyIDFromUser($_SESSION['id']) ;
}
...
if ($_SESSION['id'] == 10 && !isset($_GET['company']))
  list ($all_equipments_geoposition_js, $all_equipments_marker_js, $google_map_zoom) = buildMultiGeoPositionsOverview() ;
else
  list ($all_equipments_geoposition_js, $all_equipments_marker_js, $google_map_zoom) = buildMultiGeoPositionsOverview($company) ;
