...
function buildMetChart()
{

  // Add the image to be replaced asap
  $final_met_chart = "<img class=\"main_met_graph\" src=\"images/chart.jpg\" />
";
...
<td>31.57 C</td>
<td>1 Hour ago</td>
<td><span class=\"option selectable remove\" plot_number=\"0\" series=\"0\">PLOT<span class=\"check_plot\"><i class=\"fa fa-check fa-2x\"></i></span></span>
    <span class=\"option selectable add\" plot_number=\"0\" series=\"0\">PLOT</span></td>
</tr>
...
<td>33.42%</td>
<td>4 minutes ago</td>
<td><span class=\"option selectable remove\" plot_number=\"1\" series=\"1\">PLOT<span class=\"check_plot\"><i class=\"fa fa-check fa-2x\"></i></span></span>
    <span class=\"option selectable add\" plot_number=\"1\" series=\"1\">PLOT</span></td>
</tr>
...
<td>23.50 C</td>
<td>4 minutes ago</td>
<td><span class=\"option selectable remove\" plot_number=\"2\" series=\"2\">PLOT<span class=\"check_plot\"><i class=\"fa fa-check fa-2x\"></i></span></span>
    <span class=\"option selectable add\" plot_number=\"2\" series=\"2\">PLOT</span></td>
</tr>
...
<td>0.047 m/s</td>
<td>4 minutes ago</td>
<td><span class=\"option selectable remove\" plot_number=\"3\" series=\"3\">PLOT<span class=\"check_plot\"><i class=\"fa fa-check fa-2x\"></i></span></span>
    <span class=\"option selectable add\" plot_number=\"3\" series=\"3\">PLOT</span></td>
</tr>
...
<td>1 Hour ago</td>
<td><span class=\"option selectable remove\" plot_number=\"4\" series=\"4\">PLOT<span class=\"check_plot\"><i class=\"fa fa-check fa-2x\"></i></span></span>
    <span class=\"option selectable add\" plot_number=\"4\" series=\"4\">PLOT</span></td>
</tr>
...
<td>1897.200 mm</td>
<td>4 minutes ago</td>
<td><span class=\"option selectable remove\" plot_number=\"5\" series=\"5\">PLOT<span class=\"check_plot\"><i class=\"fa fa-check fa-2x\"></i></span></span>
    <span class=\"option selectable add\" plot_number=\"5\" series=\"5\">PLOT</span></td>
</tr>
...
<td>0.000 W/m2</td>
<td>1 Hour ago</td>
<td><span class=\"option selectable remove\" plot_number=\"6\" series=\"6\">PLOT<span class=\"check_plot\"><i class=\"fa fa-check fa-2x\"></i></span></span>
    <span class=\"option selectable add\" plot_number=\"6\" series=\"6\">PLOT</span></td>
</tr>
...
<td>1 Hour ago</td>
<td><span class=\"option selectable remove\" plot_number=\"7\" series=\"7\">PLOT<span class=\"check_plot\"><i class=\"fa fa-check fa-2x\"></i></span></span>
    <span class=\"option selectable add\" plot_number=\"7\" series=\"7\">PLOT</span></td>
</tr>
...
<td>98.340 kPA</td>
<td>4 minutes ago</td>
<td><span class=\"option selectable remove\" plot_number=\"8\" series=\"8\">PLOT<span class=\"check_plot\"><i class=\"fa fa-check fa-2x\"></i></span></span>
    <span class=\"option selectable add\" plot_number=\"8\" series=\"8\">PLOT</span></td>
</tr>
...
<td>16.750 ug/m3</td>
<td>4 minutes ago</td>
<td><span class=\"option selectable remove\" plot_number=\"9\" series=\"9\">PLOT<span class=\"check_plot\"><i class=\"fa fa-check fa-2x\"></i></span></span>
    <span class=\"option selectable add\" plot_number=\"9\" series=\"9\">PLOT</span></td>
</tr>
...
<td>19.750 ug/m3</td>
<td>4 minutes ago</td>
<td><span class=\"option selectable remove\" plot_number=\"10\" series=\"10\">PLOT<span class=\"check_plot\"><i class=\"fa fa-check fa-2x\"></i></span></span>
    <span class=\"option selectable add\" plot_number=\"10\" series=\"10\">PLOT</span></td>
</tr>
...
//" ;
  ...
  $final_sensor_chart = "  <div id=\"chartContainer\" style=\"height: 400px; width: 100%;\">
  </div>" ;
...
function buildSensorChartContainerJS()
{
...
// Builds and returns JS data for 
function buildSensorSeriesToPlotJS()
{

  // Construct the plot series for the Chart to be displayed
  $final_sensor_series_js = "     if (series_to_plot == 0)
    {
